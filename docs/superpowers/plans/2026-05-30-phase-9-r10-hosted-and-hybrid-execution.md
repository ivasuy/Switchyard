...
- `{ codepath: "HostedWorkerService.adapterMap", failure: "job runtime is not fake.deterministic", exception: "HostedRuntimeNotAllowedError", rescue: "fail job and run with reasonCode hosted_runtime_not_allowed; do not instantiate local adapters", user_sees: "run.failed hosted_runtime_not_allowed" }`
