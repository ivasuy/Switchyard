...
R21 production hosted + provider boundary wording:
...
- R21 does not ship generic process/PTY runtime adapters, Cursor/OpenClaw/Paperclip adapters, hosted browser/search/GitHub/fetch/repo tools, hosted approval bridge/input bridge/terminal bridge, hosted debate real participants, or hosted model judging.
